                                                                ...
                                                                <div class="col-sm-4" style="display: none">
                                                                    <div class="form-group">
                                                                        <label for="max_quantity_<?php echo $extra->get( 'id' ) ?>">
                                                                            <?php _e( 'Quantity', 'bookly' ) ?>
                                                                        </label>
                                                                        <input name="extras[<?php echo $extra->get( 'id' ) ?>][max_quantity]" class="form-control" type="number" step="1" id="max_quantity_<?php echo $extra->get( 'id' ) ?>" min="0" value="<?php echo $extra->get( 'max_quantity' ) ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
