        ...
        <div class="panel panel-default bookly-main">
            <div class="panel-body">
                ...
                <table id="bookly-customers-list" class="table table-striped" width="100%">
                    <thead>
                        <tr>
                            <th><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'ab_appearance_text_label_name' ) ?></th>
                            <th><?php _e( 'User', 'bookly' ) ?></th>
                            <th><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'ab_appearance_text_label_phone' ) ?></th>
                            <th><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'ab_appearance_text_label_email' ) ?></th>
