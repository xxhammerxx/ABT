                                ...
                                <div class="btn-group bookly-margin-bottom-lg">
                                    ...
                                    <ul class="dropdown-menu" style="width: 570px">
                                        <li class="bookly-padding-horizontal-md">
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" id="ab-filter-all-staff" ng-model="allNotifications" ng-change="toggleAllNotifications()">
                                        ...
                                        <li class="bookly-padding-horizontal-md" ng-repeat="notification in dataSource.notifications">
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" id="" value="0" data-staff_name="" class="ab-staff-filter"
