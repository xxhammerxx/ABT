    ...
    <div class="ab-payment-nav">
        ...
        <div class="ab-row ab-list">
            <label>
                ...
                <img style="margin: 2px 0 0 19px;" src="<?php echo plugins_url( 'frontend/resources/images/paypal.png', \Bookly\Lib\Plugin::getMainFile() ) ?>" alt="paypal">
            </label>
        </div>
        ...
        <div class="ab-row ab-list">
            <label>
                ...
                <img style="margin: 2px 0 0 19px;" src="<?php echo plugins_url( 'frontend/resources/images/cards.png', \Bookly\Lib\Plugin::getMainFile() ) ?>" alt="cards">
            </label>
        ...
        <div class="ab-row ab-list">
            <label>
                ...
                <img style="margin: 2px 0 0 19px;" src="<?php echo plugins_url( 'frontend/resources/images/mollie.png', \Bookly\Lib\Plugin::getMainFile() ) ?>" alt="mollie">
            </label>
        </div>
    </div>
