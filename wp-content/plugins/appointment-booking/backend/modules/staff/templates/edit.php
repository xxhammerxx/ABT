                ...
                <div id="bookly-details-container">
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <p class="help-block">
                                <?php _e( 'This text can be inserted into notifications with [[STAFF_INFO]] code.', 'bookly' ) ?>
                            </p>
                            <textarea id="bookly-info" name="info" rows="3" type="text" class="form-control"><?php echo esc_textarea( $staff->get( 'info' ) ) ?></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <p class="help-block">
                                <?php _e( 'Synchronize the data of the staff member bookings with Google Calendar.', 'bookly' ) ?>
                            </p>
                            <p>
                        ...
                        <div class="panel-footer">
                            <?php if ( \Bookly\Lib\Utils\Common::isCurrentUserAdmin() ) : ?>
                                <?php \Bookly\Lib\Utils\Common::deleteButton( 'bookly-delete', 'btn-lg pull-left' ) ?>
                            <?php endif ?>
