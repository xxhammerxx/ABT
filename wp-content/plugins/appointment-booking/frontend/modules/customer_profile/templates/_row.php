        ...
        <?php foreach ( $columns as $column ) :
            switch ( $column ) :
                        ...
                        <?php if ( is_array( $app['extras'] ) ) : ?>
                            <?php foreach ( $app['extras'] as $position => $extra ) : ?>
                                <tr>
                                    ...
                                    <td style="text-align: right"> <?php echo \Bookly\Lib\Utils\Common::formatPrice( $extra['price'] ) ?></td>
                                </tr>
                            <?php endforeach ?>
                        <?php endif ?>
                        </tbody>
                ...
                case 'time': ?>
                    ...
                    break;
                case 'price': ?>
                    <td><?php echo \Bookly\Lib\Utils\Common::formatPrice( ( $app['price'] + $extras_total_price ) * $app['number_of_persons'] ) ?></td><?php
                    break;
                case 'status': ?>
