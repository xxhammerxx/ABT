...
<div class="ab-details-step">
    <div class="ab-row bookly-table">
        <div class="ab-formGroup">
            <label><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'ab_appearance_text_label_name' ) ?></label>
            <div>
        ...
        <div class="ab-formGroup">
            <label><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'ab_appearance_text_label_phone' ) ?></label>
            <div>
        ...
        <div class="ab-formGroup">
            <label><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'ab_appearance_text_label_email' ) ?></label>
            <div>
