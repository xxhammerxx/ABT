...
<?php if ( get_option( 'ab_settings_coupons' ) ) : ?>
    ...
    <div class="ab-row ab-list">
        <?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'ab_appearance_text_label_coupon' ) ?>
        <?php if ( $coupon_code ) : ?>
        ...
        <?php else : ?>
            ...
            <button class="ab-btn ladda-button btn-apply-coupon" data-style="zoom-in" data-spinner-size="40">
                <span class="ladda-label"><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'ab_appearance_text_button_apply' ) ?></span><span class="spinner"></span>
            </button>
        <?php endif ?>
    ...
    <?php if ( $pay_paypal ) : ?>
        <div class="ab-row ab-list">
            <label>
                ...
                <img src="<?php echo plugins_url( 'frontend/resources/images/paypal.png', \Bookly\Lib\Plugin::getMainFile() ) ?>" style="margin-left: 10px;" alt="paypal" />
            </label>
