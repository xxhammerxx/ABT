...
<script type="text/javascript">
    (function (win, fn) {
        ...
        window.bookly({
            ...
            staff_required : <?php echo (int) get_option( 'ab_appearance_required_employee' ) ?>,
            ...
            <?php else : ?>
                enabled  : true,
                utils    : <?php echo json_encode( plugins_url( 'intlTelInput.utils.js', \Bookly\Lib\Plugin::getDirectory() . '/frontend/resources/js/intlTelInput.utils.js' ) ) ?>,
            ...
            cart           : {
                enabled  : <?php echo $woocommerce_enabled ? '0' : (int) \Bookly\Lib\Config::showStepCart() ?>
            },
