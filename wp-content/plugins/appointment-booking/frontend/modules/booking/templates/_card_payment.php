...
<div class="ab-row bookly-table">
    <div class="ab-formGroup" style="width:200px!important">
        <label><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'ab_appearance_text_label_ccard_number' ) ?></label>
        <div>
            <input type="text" name="ab_card_number" autocomplete="off" />
        </div>
    </div>
    <div class="ab-formGroup">
        <label><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'ab_appearance_text_label_ccard_expire' ) ?></label>
        <div>
...
<div class="ab-row ab-clearBottom">
    <div class="ab-formGroup">
        <label><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'ab_appearance_text_label_ccard_code' ) ?></label>
        <div>
