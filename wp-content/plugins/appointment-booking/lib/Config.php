...
abstract class Config
{
    ...
    /**
     * Consecutive Appointments Add-on enabled or not.
     *
     * @return bool
     */
    public static function consecutiveAppointmentsEnabled()
    {
        return Utils\Common::isActivePlugin( 'bookly-addon-consecutive-appointments/main.php' );
    }
